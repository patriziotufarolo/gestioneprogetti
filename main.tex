...
\draw[anchor=north] (midpoint) node [text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering CiViEl\\ % Book title
{\Large Cloud-based virtual laboratory}\\[300pt] % Subtitle
